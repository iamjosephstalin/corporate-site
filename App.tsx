                ...
                <div className="relative z-10">
                    ...
                    <Reveal delay={200}>
                        <p className="font-sans text-lg md:text-xl leading-relaxed text-ink/80 mb-8">
                            ShichifukuTekx FZE provides enterprise-grade AI and software solutions. We operate from the Ajman Free Zone, delivering compliant, secure technology to the UAE and GCC markets.
                        </p>
                        <p className="font-sans text-lg md:text-xl leading-relaxed text-ink/80">
                            We bridge the gap between regional business requirements and global technology standards. Our team specializes in Python, React, and Large Language Model (LLM) integration.
                        </p>
                    </Reveal>
                </div>
